...
const RestaurantItems = () => {
  ...
  useEffect(() => {
    const fetchRestaurants = async () => {
      try {
        const response = await fetch('https://back.eatplay.kz/restaurants');
        if (!response.ok) {
  ...
  useEffect(() => {
    const fetchDishes = async () => {
      try {
        const response = await fetch('https://back.eatplay.kz/dishes');
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
        const data = await response.json();
  ...
  const deleteRestaurant = async (id) => {
    try {
      const response = await fetch(`https://back.eatplay.kz/restaurants/${id}`, {
        method: 'DELETE',
      });
      if (!response.ok) {
        throw new Error('Network response was not ok');
  ...
  const deleteDish = async () => {
    ...
    try {
      const response = await fetch(`https://back.eatplay.kz/restaurants/${selectedDishForDeletion.restaurantId}/dishes/${selectedDishForDeletion.dishId}`, {
        method: 'DELETE',
      });
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
      const updatedRestaurants = await fetch('https://back.eatplay.kz/restaurants/').then(res => res.json());
  ...
  const handleAddDish = async (event, restaurantId) => {
    ...
    try {
      const response = await fetch(`https://back.eatplay.kz/restaurants/${restaurantId}/dishes`, {
        method: 'POST',
        headers: {
  ...
  const handleAddPreference = async (event, restaurantId) => {
    event.preventDefault();
    try {
      const response = await fetch(`https://back.eatplay.kz/restaurants/${restaurantId}/preferences`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const deletePreference = async () => {
    ...
    try {
      const response = await fetch(`https://back.eatplay.kz/${selectedPreferenceForDeletion.restaurantId}/preferences/${selectedPreferenceForDeletion.preferenceId}`, {
        method: 'DELETE',
      });
      if (!response.ok) {
        throw new Error('Network response was not ok');
